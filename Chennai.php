...
$qry = "Select Rental_location_id,Title,Max_guests,Room_type,Cost_per_night,Description,Host_id,Street_address,City,State,Country,Pincode From rental_location Where City='Chennai   '"; 
...
echo '<!-- Header -->
<header class="w3-display-container w3-content" style="max-width:750px; margin-left:1100px; margin-right:-450px;">
